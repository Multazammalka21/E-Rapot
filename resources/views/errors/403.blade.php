...
<head>
    ...
    <title>403 — Akses Ditolak | E-Rapot SMPN 1</title>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .code { font-size: 7rem; font-weight: 800; background: linear-gradient(135deg, #ef4444, #f97316); -webkit-background-clip: text; -webkit-text-fill-color: transparent; line-height: 1; margin-bottom: 0.5rem; }
...
<body>
    <div class="container">
        ...
        <h1>Akses Ditolak</h1>
        <p>Anda tidak memiliki izin untuk mengakses halaman ini. Pastikan Anda login dengan akun yang sesuai dengan peran Anda.</p>
        <a href="{{ url()->previous() !== url()->current() ? url()->previous() : route('login') }}">← Kembali</a>
    </div>
</body>
</html>
